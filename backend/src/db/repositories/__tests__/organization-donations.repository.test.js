...
describe('OrganizationDonationsRepository', () => {
  ...
  describe('createMany', () => {
    it('should create multiple organization donations', async () => {
      ...
      const orgDonations = await organizationDonationsRepository.createMany([
        { donationId: donation.id, organizationInternalId: 'AMF', amount: 3000 },
      ...
      expect(orgDonations[0].amount + orgDonations[1].amount + orgDonations[2].amount).toBe(6000);
    });
  ...
  describe('findByDonationId', () => {
    it('should find all organization donations for a donation', async () => {
      ...
      const orgDonations = await organizationDonationsRepository.findByDonationId(donation.id);

      expect(orgDonations).toHaveLength(2);
      expect(orgDonations.find(od => od.organizationInternalId === 'AMF')).toBeDefined();
      expect(orgDonations.find(od => od.organizationInternalId === 'GD')).toBeDefined();
    });
  ...
  describe('findByOrganizationInternalId', () => {
    it('should find all donations for an organization', async () => {
      ...
      const orgDonations = await organizationDonationsRepository.findByOrganizationInternalId('AMF');
  ...
  describe('updateForDonation', () => {
    it('should delete old splits and create new ones', async () => {
      ...
      const updated = await organizationDonationsRepository.updateForDonation(donation.id, [
      ...
      const allSplits = await organizationDonationsRepository.findByDonationId(donation.id);
      expect(allSplits).toHaveLength(2);
      expect(allSplits.find(od => od.organizationInternalId === 'AMF')).toBeUndefined();
      expect(allSplits.find(od => od.organizationInternalId === 'GD')).toBeDefined();
      expect(allSplits.find(od => od.organizationInternalId === 'EV')).toBeDefined();
    });
    ...
    it('should handle empty update (remove all splits)', async () => {
      ...
      const splits = await organizationDonationsRepository.findByDonationId(donation.id);
  ...
  describe('deleteByDonationId', () => {
    it('should delete all organization donations for a donation', async () => {
      ...
      const remaining = await organizationDonationsRepository.findByDonationId(donation.id);
  ...
  describe('organizationHasDonations', () => {
    it('should return true if organization has donations', async () => {
      ...
      const hasDonations = await organizationDonationsRepository.organizationHasDonations('AMF');

      expect(hasDonations).toBe(true);
    });

    it('should return false if organization has no donations', async () => {
      const hasDonations = await organizationDonationsRepository.organizationHasDonations('NONEXISTENT');
  ...
  describe('Donation split integrity', () => {
    it('should correctly split donation amount across organizations', async () => {
      ...
      await organizationDonationsRepository.createMany([
        { donationId: donation.id, organizationInternalId: 'AMF', amount: 4000 },
