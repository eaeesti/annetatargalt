...
const organizationRecurringDonations = pgTable(
...
const recurringDonationsRelations = relations(
  recurringDonations,
  ({ one, many }) => ({
    donor: one(donors, {
...
const organizationDonationsRelations = relations(
...
const organizationRecurringDonationsRelations = relations(
